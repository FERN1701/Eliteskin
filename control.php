        ...
        //<Mail> ---------------------------------------------------------------------------------------------------
                            ...
                            function emails($email, $subject, $message){
                                ...
                                $mail->SMTPDebug = 0;                    //Enable verbose debug output
                                    ...
                                    //Recipients
                                    $mail->setFrom('Eliteskin@gmail.com', 'Sign up Verification');
        ...
        //< external control> ---------------------------------------------------------------------------------------
            if(isset($_POST['signup'])){
                ...
                if(count($errors) === 0){
                    ...
                    $status = "notverified";
                    $insert_data = "INSERT INTO users (first_name, last_name, contact, address, email, password, code, status) values('$first','$last','$mobile','$address','$email', '$encpass', '$code', '$status')";
                    ...
                    if($data_check){
                        ...
                        Your OTP Code: <b style='color: orange;'>$code</b>
                        <br>
