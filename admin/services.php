                                        ...
                                        <div class="col-sm-6">
                                             <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" name="icon" class="form-control" id="" value="<?php echo $services['icon']?>">
                                                </div>
                                                <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6 mt-3">
                                                  <button type="submit" class="btn btn-outline-primary" name="services">Submit</button>
                                                </div>
                                             </div>
                                        </div>
									...
									<tbody>
                                        <?php while ($servicez = mysqli_fetch_array($ser)) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="services.php?editser=<?php echo $servicez['serviceID']?>" class="btn btn-info">Edit</a>
                                                    <a href="services.php?deleteser=<?php echo $servicez['serviceID']?>" class="btn btn-danger">Delete</a>
                                                </td>
										    </tr>
                                        <?php }?>
